...
class TestCreate:
    ...
    def test_create_with_invalid_field_raises_error(
        self, db_session: Session, sample_job: dict,
    ) -> None:
...
class TestRead:
    ...
    @pytest.mark.parametrize("job_id, expected_outcome", [(1, True), (888, False)])
...
class TestUpdate:
    ...
    def test_try_updating_passing_nonexistent_id(self, db_session: Session, sample_job_updates: dict, sample_job_data: dict) -> None:
        create_job(db_session, sample_job_data)
        invalid_id = 999
